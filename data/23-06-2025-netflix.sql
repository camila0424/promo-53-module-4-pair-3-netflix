CREATE DATABASE  IF NOT EXISTS `netflix_ejercicio` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `netflix_ejercicio`;
-- MySQL dump 10.13  Distrib 8.0.42, for Win64 (x86_64)
--
-- Host: localhost    Database: netflix_ejercicio
-- ------------------------------------------------------
...
CREATE TABLE `movies_has_users` (
  ...
  PRIMARY KEY (`movies_idmovies`,`users_idUsers`),
  KEY `fk_movies_has_users_users1_idx` (`users_idUsers`),
  ...
  CONSTRAINT `fk_movies_has_users_users1` FOREIGN KEY (`users_idUsers`) REFERENCES `users` (`idUsers`)
...
INSERT INTO `users` VALUES (1,'laura_dev','laura','Laura','laura@gamil.com','Standard'),(2,'maria_dev','maria','Maria','maria@gmail.com','Standard'),(3,'ester_dev','ester','Ester','ester@gmail.com','Standard');
...
-- Dump completed on 2025-06-23 11:06:56
